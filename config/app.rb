...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'simple-todo.com'
  config.app_name = 'Simple-todo'
  config.mailer.from = 'Simple-todo <no-reply@simple-todo.com>'
  ...
  #
  config.app_secret = 'JlnX1jz6DD70k8TZuRH5KnFtTq85OyufEjbSCwfTs78zujmIr0-U1V8JDHLnox2vaHE'
